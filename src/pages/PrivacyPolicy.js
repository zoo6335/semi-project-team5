...
const PrivacyPolicy = () => {
  return (
    <Context>
      ...
      <div>
        <p>
          {"<"} NagaBang {">"}('http://localhost:3000/'이하 'NagaBang')은(는)
        ...
        <p>3. 재화 또는 서비스 제공</p>
        <p>
          콘텐츠 제공, 맞춤서비스 제공, 본인인증을 목적으로 개인정보를
          처리합니다.
        </p>
        <p>4. 마케팅 및 광고에의 활용</p>
        <p>
        ...
        <p>
          ① {"<"} NagaBang {">"}은(는) 법령에 따른 개인정보 보유·이용기간 또는
        ...
        <p>
          ① {"<"} NagaBang {">"}은(는) 다음의 개인정보 항목을 처리하고 있습니다.
        </p>
        <p>
          1{"<"} 홈페이지 회원가입 및 관리 {">"}
        </p>
        ...
        <p>
          ① {"<"} NagaBang {">"} 은(는) 개인정보 보유기간의 경과, 처리목적 달성
        ...
        <p>1. 파기절차</p>
        <p>
          {"<"} NagaBang {">"} 은(는) 파기 사유가 발생한 개인정보를 선정하고,{" "}
          {"<"} NagaBang {">"} 의 개인정보 보호책임자의 승인을 받아 개인정보를
          파기합니다.
        </p>
        <p>2. 파기방법</p>
        <p>
        ...
        <p>
          ① 정보주체는 NagaBang에 대해 언제든지 개인정보 열람·정정·삭제·처리정지
          요구 등의 권리를 행사할 수 있습니다.
        </p>
        <p>
          ② 제1항에 따른 권리 행사는NagaBang에 대해 「개인정보 보호법」 시행령
          제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수
          있으며 NagaBang은(는) 이에 대해 지체 없이 조치하겠습니다.
        </p>
        <p>
        ...
        <p>
          ⑥ NagaBang은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
        ...
        <p>
          {" "}
          {"<"} NagaBang {">"}은(는) 개인정보의 안전성 확보를 위해 다음과 같은
          조치를 취하고 있습니다.
        </p>
        ...
        <p>
          NagaBang 은(는) 정보주체의 이용정보를 저장하고 수시로 불러오는
          ‘쿠키(cookie)’를 사용하지 않습니다.
        </p>
        <br />
        <p>제9조 (개인정보 보호책임자에 관한 사항)</p>
        <p>
          ① NagaBang 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고,
        ...
        <p>
          ② 정보주체께서는 NagaBang 의 서비스(또는 사업)을 이용하시면서 발생한
          모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을
          개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. NagaBang
          은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.
        </p>
        <br />
        <p>제10조(개인정보의 열람청구를 접수·처리하는 부서)</p>
        <p>
          정보주체는 ｢개인정보 보호법｣ 제35조에 따른 개인정보의 열람 청구를
          아래의 부서에 할 수 있습니다.
        </p>
        <p>
          {"<"} NagaBang {">"}은(는) 정보주체의 개인정보 열람청구가 신속하게
          처리되도록 노력하겠습니다.
        </p>
