...
const FB_DOMAIN = "http://localhost:8090/kh_mini_project/";
...
const Api = {
    ...
    tradeBoardList: async function() {
        ...
        return await axios.post(FB_DOMAIN + "TradeBoardListServlet", regCmd, HEADER);
    },
    ...
    recommendBoardList: async function() {
        ...
        return await axios.post(FB_DOMAIN + "RecommendBoardListServlet", regCmd, HEADER);
    },
    ...
    fBoardCreate: async function(fb_category, fb_user_id, fb_title, fb_content) {
        ...
        return await axios.post(FB_DOMAIN + "FBoardCreateServlet", boardObj, HEADER);
    },
    ...
    fboardUpdatePull: async function(fb_id) {
        ...
        return await axios.post(FB_DOMAIN + "UpdatePullBoardServlet", regCmd, HEADER);
    },
    ...
    fboardUpdatePush: async function(fb_category, fb_title, fb_content, fb_id) {
        ...
        return await axios.post(FB_DOMAIN + "UpdatePushBoardServlet", boardCmd, HEADER);
    },
    ...
    fBoardComment: async function (fb_id) {
        ...
        return await axios.post(FB_DOMAIN + "CommentBoardServlet", boardCmd, HEADER);
      }
}
export default Api;